...
----------------------------------------------------------------
  ...
  ** Cal que en les diferents comandes substituïu la paraula USUARI 
...
4.) Compilar i muntar de manera normal incloent la biblioteca:

compilar: g++ -c -Wall arxiu.cpp

muntar: g++ -o nom_executable.e arxiu1.o arxiu2.o -lesin
...
3.) Compilar i muntar de manera normal incloent la biblioteca:
